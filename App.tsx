...
export default function App() {
  ...
  return (
    ...
    <SafeAreaView className='flex-1 justify-center items-center p-none bg-night'>
      {pages[stepIndex]}
      <View className='h-48 justify-end p-10'>
        ...
        className='bg-crimson p-5 w-96 rounded-md'>
          <Text className='text-silver text-center font-bold'>Começar agora!</Text>
        </Pressable>
        }
      </View>
...
function Welcome(){
  return <View className="flex-1 justify-center bg-night">
          ...
          <Text className='mt-10 text-xl text-silver w-96 text-left'>Seu novo app favorito para organizar seus afazeres.{("\n\n")}Aqui, irá criar listas, to-dos e configura-los para maximizar sua produtividade e não esquecer do que você tem que fazer.</Text>
        </View>;
}
